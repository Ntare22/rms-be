...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/organizations/{id}/payments/pesapal/ipn/list": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/organizations/{id}/payments/pesapal/ipn/register": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/organizations/{id}/payments/transaction-status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
