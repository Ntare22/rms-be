...
type CreateTenantRequest struct {
	...
	BillingDueDay  *int   `json:"billing_due_day" binding:"omitempty,min=1,max=31" example:"1"`
	BillingChannel string `json:"billing_channel" binding:"omitempty,oneof=email sms" example:"email"`
...
type PatchTenantRequest struct {
	...
	BillingChannel *string `json:"billing_channel" binding:"omitempty,oneof=email sms"`
...
type TenantResponse struct {
	...
	BillingChannel   string              `json:"billing_channel,omitempty" example:"email"`
