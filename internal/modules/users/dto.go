...
type CreateUserRequest struct {
	...
	Role               string   `json:"role" binding:"required,oneof=admin landlord manager staff tenant" example:"staff"`
	Status             string   `json:"status" binding:"omitempty,oneof=active disabled invited" example:"active"`
	ManagerBuildingIDs []string `json:"manager_building_ids" binding:"omitempty,dive,uuid"`
}
...
type PatchUserRequest struct {
	...
	LastName           *string   `json:"last_name" binding:"omitempty,max=120" example:"Rivera"`
	Phone              *string   `json:"phone" binding:"omitempty,max=64" example:"+1-555-0199"`
	Role               *string   `json:"role" binding:"omitempty,oneof=admin landlord manager staff tenant" example:"manager"`
...
type UserResponse struct {
	...
	ManagerBuildingIDs []string  `json:"manager_building_ids,omitempty"`
